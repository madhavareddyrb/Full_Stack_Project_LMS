            ...
            <div className="flex h-[54px] w-full shrink-0  border-b p-2">
              <div className=" mt-[1.5px] flex w-full">
                <DropdownMenu modal={false}>
                  <DropdownMenuTrigger
                    className="w-full"
                    render={<Button variant="ghost" size="sm" className="flex w-fit items-center gap-2  px-2" />}><Avatar className='rounded size-4'>
                                                          <AvatarFallback>O</AvatarFallback>
                                                        </Avatar><motion.li variants={variants} className="flex w-fit items-center gap-2">
                                                          {!isCollapsed && (
                                                            <>
                  ...
                  <DropdownMenuContent align="start">
                    <DropdownMenuItem
                      ...
                      render={<Link href="/settings/members" />}><UserCog className="h-4 w-4" />Manage members
                                                            </DropdownMenuItem>{" "}
                    <DropdownMenuItem
                      className="flex items-center gap-2"
                      render={<Link href="/settings/integrations" />}><Blocks className="h-4 w-4" />Integrations
                                                            </DropdownMenuItem>
                ...
                <div>
                  <DropdownMenu modal={false}>
                    ...
                    <DropdownMenuContent sideOffset={5}>
                      ...
                      <DropdownMenuItem
                        className="flex items-center gap-2"
                        render={<Link href="/settings/profile" />}><UserCircle className="h-4 w-4" />Profile
                                                                  </DropdownMenuItem>
